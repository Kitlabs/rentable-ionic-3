    ...
    this.number=this.countrycode + this.phonenumber;  
     ...
     this.Authprovider.phoneverify(this.number).subscribe(
        data=>{
            ...
            //number exist
            if(data.json().msg=="success"){
               this.details=data.json(). user_details;
               console.log(this.details[0].status);
               
               //number register but not verified
               if(this.details[0].status=="InActive"){
               ...
               if(this.details[0].status=="Verify"){ 
                   this.Usersignup.phonenumber=this.number;
               ...
               */
               if(this.details[0].status=="Active"){
                 ...
                 console.log(this.details[0].firstName);
                  if(this.details[0].usertype=="Facebook"){

                      this.navCtrl.setRoot(TabPage,{
                        userid:this.details[0].id
                      });
