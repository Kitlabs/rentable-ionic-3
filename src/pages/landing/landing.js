...
var LandingPage = /** @class */ (function () {
    function LandingPage(navCtrl, navParams, alertCtrl, toastCtrl, Authprovider, loadingCtrl, formBuilder) {
        ...
        this.phonenumber = this.landingForm.controls['phonenumber'];
        console.log("LandingCode" + this.countrycode);
    }
    ...
    LandingPage.prototype.dolanding = function () {
        ...
        this.Authprovider.phoneverify(this.number).subscribe(function (data) {
            ...
            if (data.json().msg == "error") {
                ...
                _this.Authprovider.Sendsms(_this.number).subscribe(function (data) {
                    if (data.json().msg == "success") {
                        ...
                        _this.navCtrl.push(Register, {
                            pnumber: _this.number,
                            animation: true,
                            direction: 'forward'
                        });
                    }
            ...
            //number exist
            if (data.json().msg == "success") {
                _this.details = data.json().user_details;
                console.log(_this.details[0].status);
                //number register but not verified
                if (_this.details[0].status == "InActive") {
                    //send otp to number 
                    _this.Authprovider.Sendsms(_this.number).subscribe(function (data) {
                ...
                //number verified but registration incomplete
                if (_this.details[0].status == "Verify") {
                    _this.Usersignup.phonenumber = _this.number;
                ...
                /*registration process has been completed by user
                  take user to login screen
                */
                if (_this.details[0].status == "Active") {
                    console.log("Active");
                    console.log(_this.details[0].firstName);
                    if (_this.details[0].usertype == "Facebook") {
                        _this.navCtrl.setRoot(TabPage, {
                            userid: _this.details[0].id
                        });
                    }
                    else {
                        _this.navCtrl.push(Login, {
                            pnumber: _this.number,
                            pname: _this.details[0].firstName,
                            animation: true,
                            direction: 'forward'
                        });
                    }
    ...
    LandingPage.prototype.showToastWithCloseButton = function (msg) {
    ...
    LandingPage.prototype.showToast = function (msg) {
        var toast = this.toastCtrl.create({
            message: msg,
            duration: 2000,
            position: "top"
