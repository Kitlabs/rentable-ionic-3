...
export interface MbscTimerOptions extends MbscScrollerOptions {
    ...
    // Events
    lap?(event: { ellapsed: number, lap: number, laps: Array<number> }, inst: any): void;
...
export class Timer extends Scroller {
    settings: MbscTimerOptions;
    handlers: {
        set: () => void,
        cancel: () => void,
        clear: () => void
    ...
    constructor(element: any, settings: MbscTimerOptions);
    start(): void;
    stop(): void;
    toggle(): void;
    reset(): void;
